...
def signup():
    if request.method == 'POST':
        ...
        session['signup_data'] = {
            ...
            'password': password,
            'metamask_address': metamask_address,
            'face_token': face_token  # Store the face_token in session
        }
